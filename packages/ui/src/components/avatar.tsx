...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "size-8 rounded-full after:rounded-full data-[size=lg]:size-10 data-[size=sm]:size-6 data-[size=xs]:size-7 after:border-border-default group/avatar relative flex shrink-0 select-none after:absolute after:inset-0 after:border after:mix-blend-darken dark:after:mix-blend-lighten",
        className
      )}
      {...props}
    />
...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "bg-bg-muted text-content-muted rounded-full flex size-full items-center justify-center overflow-hidden text-sm group-data-[size=sm]/avatar:text-xs group-data-[size=xs]/avatar:text-xs",
        className
      )}
      {...props}
    >
...
function AvatarBadge({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn(
        "bg-bg-inverted text-content-inverted ring-bg-default absolute right-0 bottom-0 z-10 inline-flex items-center justify-center rounded-full bg-blend-color ring-2 select-none",
...
function AvatarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "*:data-[slot=avatar]:ring-bg-default group/avatar-group flex -space-x-2 *:data-[slot=avatar]:ring-2",
        className
      )}
      {...props}
    />
...
function AvatarGroupCount({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-bg-muted text-content-muted size-8 rounded-full text-sm group-has-data-[size=lg]/avatar-group:size-10 group-has-data-[size=sm]/avatar-group:size-6 [&>svg]:size-4 group-has-data-[size=lg]/avatar-group:[&>svg]:size-5 group-has-data-[size=sm]/avatar-group:[&>svg]:size-3 ring-bg-default relative flex shrink-0 items-center justify-center ring-2",
        className
      )}
      {...props}
    />
