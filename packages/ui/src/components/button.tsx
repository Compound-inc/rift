  ...
  "focus-visible:border-border-strong focus-visible:ring-border-strong/50 aria-invalid:ring-foreground-error/20 dark:aria-invalid:ring-foreground-error/40 aria-invalid:border-foreground-error dark:aria-invalid:border-foreground-error/50 rounded-lg border border-transparent bg-clip-padding text-sm font-medium focus-visible:ring-[3px] aria-invalid:ring-[3px] [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none hover:bg-surface-inverse/5 active:bg-surface-inverse/10",
  {
    variants: {
      variant: {
        ...
        ghost: "bg-transparent text-foreground-primary",
        danger:
        ...
        sidebarIcon:
          "duration-0 focus-visible:ring-2 focus-visible:ring-border-strong/50 data-[active=true]:bg-surface-inverse/5 data-[active=true]:hover:bg-surface-inverse/5 data-[active=true]:active:bg-surface-inverse/5 hover:transition-colors active:transition-colors",
        sidebarNavItem:
        ...
        link: "bg-transparent border-0 shadow-none text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium hover:bg-transparent active:bg-transparent whitespace-nowrap",
      },
      size: {
        default:
        ...
        big: "h-12 w-full rounded-2xl gap-2.5 transition-all duration-200",
        icon: "aspect-square h-10 w-10 rounded-lg",
        iconSmall: "aspect-square h-7.5 w-7.5",
        iconSidebar:
