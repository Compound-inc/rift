  ...
  if (authLoading) {
    return (
      <div className="relative z-10 flex min-h-[40vh] items-center justify-center p-8">
        <p className="text-content-muted">{m.auth_invitation_loading()}</p>
      </div>
    )
  }
          ...
          >
            {actionSuccess ? (
              ...
              >
                <div className="relative mb-4 inline-flex">
                  <Avatar className="border border-border-default/60 shadow-sm" size="xl">
                    <AvatarFallback
                  ...
                  <span className="absolute -bottom-0.5 -right-0.5 flex size-5 items-center justify-center rounded-full bg-content-success text-white ring-2 ring-bg-muted">
                    <Check strokeWidth={3} className="size-2.5" />
                  </span>
                </div>
                <h2 className="mb-2 text-xl font-bold text-content-default">
              ...
              <motion.div
                ...
                className="flex flex-col items-center pb-2 pt-4 text-center"
              >
                <div className="mb-4 flex size-16 items-center justify-center rounded-full bg-content-error/10">
                  <AlertTriangle className="size-8 text-content-error" />
                </div>
                <h2 className="mb-2 text-xl font-bold text-content-default">
              ...
              >
                <div className="mb-4 flex items-center justify-center">
                  {invitation ? (
                    ...
                    <div className="size-12 animate-pulse rounded-full bg-content-muted/20" aria-hidden="true" />
                  )}
                </div>
                ...
                <div className="text-center">
                  ...
                  {invitation ? (
                    ...
                    <div className="mt-2 flex flex-col items-center space-y-2">
                      <div className="h-[1.75rem] w-48 animate-pulse rounded-md bg-content-muted/30" aria-hidden="true" />
                      <div className="h-[1.25rem] w-32 animate-pulse rounded-md bg-content-muted/20" aria-hidden="true" />
                    </div>
                  )}
                </div>
              </motion.div>
            ...
            {actionError && !actionSuccess ? (
              <motion.div
                ...
                animate="visible"
              >
                <p className="text-sm text-content-error">{actionError}</p>
              </motion.div>
            ) : null}
          </motion.div>
        </div>
