...
CREATE INDEX IF NOT EXISTS topup_product_active ON topup_product (active);
...
CREATE INDEX IF NOT EXISTS org_topup_order_organization_id ON org_topup_order (organization_id);
...
CREATE INDEX IF NOT EXISTS org_topup_grant_org_user ON org_topup_grant (organization_id, user_id);
CREATE INDEX IF NOT EXISTS org_topup_grant_status ON org_topup_grant (status);

-- org_topup_grant_ledger
...
CREATE INDEX IF NOT EXISTS org_topup_grant_ledger_grant_id ON org_topup_grant_ledger (org_topup_grant_id);
