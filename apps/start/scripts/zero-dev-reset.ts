...
async function main(): Promise<void> {
  ...
  try {
    ...
    await runSql(
      pool,
      `CREATE PUBLICATION zero_data FOR TABLE "user", organization, member, "organizationRole", threads, messages, org_policy, org_product_policy, attachments, org_billing_account, org_subscription, org_entitlement_snapshot, org_member_access`,
